...
public class MatriculaValida {
    public static void main(String[] args) {
        ...
        // Puc fer if anitats però hauria de posar un else a cada if per dir que no és una matrícula vàlida
        // He intentat fer-ho amb un bucle for però no va funcionar
        // Es que aquesta estructura no està bé
        if (matricula.length() == 7 && 
            Character.isUpperCase(matricula.charAt(0)) && 
            ...
            matricula.charAt(5) != 'I' && matricula.charAt(5) != 'O' && 
            matricula.charAt(5) != 'Q' && matricula.charAt(5) != 'U' && 
            Character.isUpperCase(matricula.charAt(6)) && 
            matricula.charAt(6) >= 'A' && matricula.charAt(6) <= 'Z' && 
            matricula.charAt(6) != 'I' && matricula.charAt(6) != 'O' && 
            matricula.charAt(6) != 'Q' && matricula.charAt(6) != 'U') {        
