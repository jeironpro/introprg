...
public class ManipulaString {
    public static void main(String[] args){
        ...
        System.out.println("La segona lletra és '" + (paraula.length() > 1 ? paraula.charAt(1) : paraula) + "'");
        ...
        System.out.println("La penúltima lletra és '" + (paraula.length() > 1 ? paraula.charAt(paraula.length()-2) : paraula) + "'");
        ...
        // mostrarà «eNek»)
        System.out.println("La composició de quatre és " + (paraula.length() > 1 ? "\"" + paraula.charAt(paraula.length()-1) + paraula.charAt(0) + paraula.charAt(1) + paraula.charAt(2) + "\"" : "\"" + paraula) + "\"");
        ...
        System.out.println("La composició de quatre corregint majúscules és " + (paraula.length() > 1 ? "\"" + paraula.substring(paraula.length()-1).toUpperCase() + paraula.toLowerCase().charAt(0) + paraula.toLowerCase().charAt(1) + paraula.toLowerCase().charAt(2) + "\"" : "\"" + paraula) + "\"");
    }
}
