 ...
 * Una funció que rep un text, un valor inicial i un valor final i retorna un
   interval del text en el rang d'inici i final ambdós inclosos (intervalString).
 * 
 ...
 * Una funció que rep un text i un prefix (el text i prefix pot ser en
   ...
   retornar si és el prefix és el començament del text de manera seqüencial o no,
   com la utilitat de String startsWith (esPrefix flexible).
 *
 ...
 * Una funció que rep un text i un sufix (el text i sufix pot ser en majúscules,
   minúscules, contenir vocals catalanes i la ç) i un boolean i retornar si és el
   sufix és la terminació del text de manera seqüencial o no, com la utilitat de
   String endsWith (esSufix flexible).
 * 
 ...
 *
 * Una funció que rep una paraula i retornar si és decreixent de manera estricta 
   o no (esDecreixent(String)).
 *
 * Una funció que rep una paraula i retornar si és creixidecri de manera estricta
   o no (esCreixiDecri(String)).
 *
 * Una funció que rep una paraula i retornar si és decricreixi de manera estricta
   o no (esDecriCreixi(String)).
 *
 ...
 *
 * Una funció que rep una paraula i retornar si és creixidecri de manera flexible
   o no (esCreixiDecri(String, boolean)).
 *
 * Una funció que rep una paraula i retornar si és decricreixi de manera flexible
   (esDecriCreixi(String, boolean)).
 *
 * Una funció que rep un text i filtra tots els seus caràcters a l'alfabet catalá
   (filtraAlfabetCatala)
 *
 ...
 * Una funció que rep un text i compta quantes paraules hi ha en el text i
   retorna aquesta quantitat. Aquesta funció fa servir la funció espaiLletraFinal
   per agregar l'espai al text i comptar de manera funcional les paraules
   (quantsParaules).
 *
 ...
 *
 * Una funció que rep un valor de tipus text i si la funció esEnter retorna true,
   això és que es pot converteix a enter i ho retorna com enter fent servir
   Integer.parseInt. (valorEnter)
 *
 ...
 * Una funció que rep un text i un boolean, si el boolean és false retorna el
   resultat de la funció separa(String), en cas que el boolean sigui true retorna
   un array de String amb  els espais inclòs, com la utilitat de String split 
   (separa(String, boolean)).
 * 
 ...
 * Una funció que rep un array de Strings, un String com separador i un String 
   com darrer separador i retorna un String amb el array separat pels separadors 
   en l'ordre indicat, com la utilitat de String join 
   (junta(String[], String, String)).
 *
 * Una funció que rep un String de notes amb les notes separat per comes i espais
   (ex: (9, 8, ) o (10, 9, 8, )) i li aplica una nova estructura de separació 
   (9 i 8) o (10, 9 i 8). (separadorNotes)
 *
 * Una funció que rep un valor de tipus text i verifica si la longitud del valor
   és igual a 2 i si són dos nombres entre 0 i 2, per ser vàlid per l'índex d'un 
   array bidimensional de dimensió 3x3. (verificaCoordenada)
 */
