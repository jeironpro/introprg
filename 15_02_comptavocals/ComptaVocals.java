...
public class ComptaVocals {
    public static void main(String[] args) {
        ...
        for (int i = 0; i < text.length(); i++) {
            ...
            if (text.charAt(i) == 'a' || text.charAt(i) == 'à' || text.charAt(i) == 'e' || text.charAt(i) == 'è' || text.charAt(i) == 'é' || text.charAt(i) == 'i' || text.charAt(i) == 'í' || text.charAt(i) == 'ï' || text.charAt(i) == 'o' || text.charAt(i) == 'ó' || text.charAt(i) == 'ò' || text.charAt(i) == 'u' || text.charAt(i) == 'ú' || text.charAt(i) == 'ü') {
